...
.. code-block:: json
   ...
   {
     "success": true,
     "payment_url": "https://checkout.pixcorns.com/pay.php?address=...",
...
The ``payment_url`` in the response is the pixcorns.com checkout page URL. You must redirect your customer to this URL:
...
**Important**: Never embed the payment URL in an iframe. Customers must be redirected to the pixcorns.com domain directly.
...
.. code-block:: bash
   ...
   curl -X GET https://pixcorns.com/payments/api/status/{payment_id}/ \
...
.. code-block:: bash
   ...
   curl -X GET "https://pixcorns.com/payments/api/convert/?amount=100&currency=EUR" \
     -H "X-API-Key: YOUR_API_KEY_HERE"
